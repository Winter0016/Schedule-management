...
function App() {
  ...
  const checkrefreshtoken = async (myrefreshtoken) => {
    try {
      ...
      const response = await fetch("http://34.201.151.117:3000/auth/checkrefreshtoken", {
        method: "POST",
  ...
  const updateTodayTask = async (plan) => {
    ...
    try {
      ...
      if (plan && selectedOption) {
        ...
        const response = await axios.post('http://34.201.151.117:3000/update-todaytask', {
  ...
  const getplan = async (req, res) => {
    try {
      const response = await fetch("http://34.201.151.117:3000/plan", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
async function subscribe(username,title,body,time) {
  ...
  await axios.post('http://34.201.151.117:3000/subscribe', subscription,username,title,body,time);
