...
export const Register = () => {
    ...
    const checkusername = async (USERNAME) => {
        ...
        try {
            const response = await fetch('https://34.201.151.117:3000//auth/check-username', {
                method: "POST",
    ...
    const checkemail = async (EMAIL) => {
        // console.log(`Checking user ${USERNAME}`);
        try {
            const response = await fetch('https://34.201.151.117:3000//auth/check-email', {
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    const registerfunction = async (e) => {
        ...
        try {
            ...
            setloading(true);
            const response = await fetch('https://34.201.151.117:3000//auth/register', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
