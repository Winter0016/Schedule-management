...
export const Plan = () => {
  const { loggedusername,usernamerole,open,setopen,plan,setplan,deleteac,setdeleteac,addacresult,setaddacresult,setdeleteresult,createresult,setcreateresult,getplan,loadingplan } = useContext(Usercontext);
