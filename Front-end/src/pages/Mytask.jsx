...
export const Mytask = () =>{
    ...
    const updatecheckedarray = async() =>{
        try{
            ...
            const response = await axios.post("https://34.201.151.117/update-checkedarray", {
    ...
    const deletetask = async () => {
        try {
            setdeletingac(true);
            const response = await fetch("https://34.201.151.117/delete-task", {
                method: "POST",
    ...
    const deleteFinishedTask = async () => {
        try {
            ...
            const response = await axios.post("https://34.201.151.117/deletefinishedtask",{
                username:loggedusername,
                planname: selectedOption,
