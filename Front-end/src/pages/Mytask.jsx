...
export const Mytask = () =>{
    ...
    const updatecheckedarray = async() =>{
        try{
            ...
            const response = await axios.post("https://localhost/update-checkedarray", {
    ...
    const deletetask = async () => {
        try {
            setdeletingac(true);
            const response = await fetch("https://localhost/delete-task", {
                method: "POST",
    ...
    const deleteFinishedTask = async () => {
        try {
            ...
            const response = await axios.post("https://localhost/deletefinishedtask",{
                username:loggedusername,
                planname: selectedOption,
