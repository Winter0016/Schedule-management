...
export const Mytask = () =>{
    ...
    const updatecheckedarray = async() =>{
        try{
            ...
            const response = await axios.post("http://100.27.190.222:3000/update-checkedarray", {
    ...
    const deletetask = async () => {
        try {
            setdeletingac(true);
            const response = await fetch("http://100.27.190.222:3000/delete-task", {
                method: "POST",
    ...
    const deleteFinishedTask = async () => {
        try {
            ...
            const response = await axios.post("http://100.27.190.222:3000/deletefinishedtask",{
                username:loggedusername,
                planname: selectedOption,
