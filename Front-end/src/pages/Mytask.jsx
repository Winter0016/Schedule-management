...
export const Mytask = () =>{
    ...
    const updatecheckedarray = async() =>{
        try{
            ...
            const response = await axios.post("https://34.201.151.117:3000//update-checkedarray", {
    ...
    const updatetask = async(e)=>{
        ...
        try {
            ...
            const response = await axios.post("https://34.201.151.117:3000//update-task",{
                username: loggedusername,
    ...
    const deletetask = async () => {
        try {
            setdeletingac(true);
            const response = await fetch("https://34.201.151.117:3000//delete-task", {
                method: "POST",
    ...
    const deleteFinishedTask = async () => {
        try {
            ...
            const response = await axios.post("https://34.201.151.117:3000//deletefinishedtask",{
                username:loggedusername,
                planname: selectedOption,
